...
def scene_bdvd(csStore):
    ...
    # Define menu loop
    def internal_loop():
        nonlocal bdvd_pause,canvas,bdvd_logo_images,bdvd_logo_index,bdvd_logo,bdvd_lastHit
        # Update the canvas
        canvas.update()
        # Move loop
        ...
        if collides() == True:
            ...
            # Draw trail
            canvas.create_line(bdvd_lastHit[0],bdvd_lastHit[1],bdvd_pos[0],bdvd_pos[1],fill="blue")
            bdvd_lastHit[0],bdvd_lastHit[1] = bdvd_pos[0],bdvd_pos[1]
        # Check corner
